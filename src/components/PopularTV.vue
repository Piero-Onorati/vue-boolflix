<template>
  <section>
    ...
    <div class="wrapper">
      ...
      <!-- Carousel -->
      <agile :key="popularTV.length" :slidesToShow="5" :dots="false" :infinite="false"  :navButtons="false" ref="carousel">
        <div class="slide" v-for="(el,index) in popularTV" :key="index">

          <!-- IMG -->
          <img :src="'https://image.tmdb.org/t/p/w342'+el.backdrop_path" :alt="el.name">   
          <!-- Card Body -->
          <div class="card-body">
